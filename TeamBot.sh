...
if [[ $user == "" ]]; then
printf "\e[1;36m[\e[0m\e[1;36m*\e[0m\e[1;36m]\e[0m\e[1;36m Login\e[0m\n"
read -p $'\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Username: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;36m[\e[0m\e[1;36m*\e[0m\e[1;36m]\e[0m\e[1;36m Cookies found for user\e[0m\e[1;36m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Use it?\e[0m\e[1;36m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "\e[1;36m[\e[0m\e[1;36m*\e[0m\e[1;36m]\e[0m\e[1;36m Using saved credentials\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
read -s -p $'\e[1;36m[\e[0m\e[1;36m*\e[0m\e[1;36m]\e[0m\e[1;36m Password: \e[0m' pass
printf "\n"
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] Trying to login as\e[0m\e[1;36m %s\e[0m\n" $user
IFS=$'\n'
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Preparing to unfollow all followers from \e[0m\e[1;36m%s ...\e[0m\n" $user_account
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Press \"Ctrl + c\" to stop...\e[0m\n"
sleep 4
while [[ true ]]; do
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] This technique consists of following/unfolling celebgrams\e[0m\n"
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m] It can increase your followers up to about +30 in 1 hour \e[0m\n"
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Press Ctrl + C to stop \e[0m\n"
sleep 5
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Trying to follow  %s ..." $celeb
...
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Sleeping 60 secs...\e[0m\n"
sleep 60
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;36m[\e[0m\e[1;36m+\e[0m\e[1;36m]\e[0m\e[1;36m Trying to unfollow  %s ..." $celeb
check_unfollow=$(curl -s -L -b cookie.$user -d "ig_sig_key_version=4&signed_body=$hmac.$data" -s --user-agent 'User-Agent: "Instagram 10.26.0 Android (18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US)"' -w "\n%{http_code}\n" -H "$header" "https://i.instagram.com/api/v1/friendships/destroy/$celeb/" | grep -o '"following": false' ) 

if [[ $check_unfollow == "a" ]]; then
printf "\n\e[1;36m [!] Error, stoping to prevent blocking\n"
exit 1
else
printf "\e[1;36mOK\e[0m\n"
fi
...
printf "\n"
printf " \e[1;36m[\e[0m\e[1;36m01\e[0m\e[1;36m]\e[0m\e[1;36m Unfollow Tracker\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m02\e[0m\e[1;36m]\e[0m\e[1;36m Followers\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m03\e[0m\e[1;36m]\e[0m\e[1;36m Stories\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m04\e[0m\e[1;36m]\e[0m\e[1;36m Saved Content\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m05\e[0m\e[1;36m]\e[0m\e[1;36m Following List\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m06\e[0m\e[1;36m]\e[0m\e[1;36m Followers List\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m07\e[0m\e[1;36m]\e[0m\e[1;36m Profile Info\e[0m\n"
printf " \e[1;36m[\e[0m\e[1;36m08\e[0m\e[1;36m]\e[0m\e[1;36m Activate Unfollower\e[0m\n"
printf "\n"


read -p $' \e[1;36m[\e[0m\e[1;36m:\e[0m\e[1;36m]\e[0m\e[1;36m Target: \e[0m' option
...
printf "\e[1;36m[!] Invalid Option!\e[0m\n"
sleep 2
menu
